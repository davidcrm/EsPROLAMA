...
from admin_panel.views.usuarios import usuario_list, detalle_usuario, eliminar_usuario
...
urlpatterns = [
    ...
    # Listar usuarios
    path('usuarios/', view=usuario_list, name="usuarios"),
    # actualizar_orden
    ...
    # URLs para usuarios
    path('usuario/', detalle_usuario, name="crear_usuario"),
    path('usuario/<int:usuario_id>/', detalle_usuario, name="editar_usuario"),
    path('usuario/<int:usuario_id>/eliminar', eliminar_usuario, name="eliminar_usuario"),
